...
def load_checkpoint(fpath):
    ...
    try:
        checkpoint = _torch_load_checkpoint(fpath, map_location=map_location)
...
def _torch_load_checkpoint(fpath, **kwargs):
    try:
        return torch.load(fpath, weights_only=False, **kwargs)
    except TypeError:
